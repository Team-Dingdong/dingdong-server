...
==== Request
CURL
include::send-sms/curl-request.adoc[]
Request Fields
include::send-sms/request-fields.adoc[]
Request Http Example
include::send-sms/http-request.adoc[]
==== Response
Response Fields
include::send-sms/response-fields.adoc[]
Response Example
include::send-sms/response-body.adoc[]
