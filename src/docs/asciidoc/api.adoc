...
Response Example
include::{snippets}/rating-controller-test/get-my-rating/response-body.adoc[]
...
=== 5-2. 홈화면, 해당 지역의 나누기 불러오기(정렬방식: 최신순)
==== Request
CURL
...
=== 5-3. 홈화면, 해당 지역의 나누기 불러오기(정렬방식: 마감임박순)
==== Request
CURL
...
=== 5-4. 카테고리별 해당 지역의 나누기 피드들 불러오기(카테고리 화면)(정렬 방식: 최신순)
==== Request
CURL
...
=== 5-5. 카테고리별 해당 지역의 나누기 피드들 불러오기(카테고리 화면)(정렬 방식: 마감임박순)
==== Request
CURL
