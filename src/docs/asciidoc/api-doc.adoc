...
==== Request
CURL
include::{snippets}/../../src/docs/asciidoc/send-sms/curl-request.adoc[]
Request Fields
include::{snippets}/../../src/docs/asciidoc/send-sms/request-fields.adoc[]
Request Http Example
include::{snippets}/../../src/docs/asciidoc/send-sms/http-request.adoc[]
==== Response
Response Fields
include::{snippets}/../../src/docs/asciidoc/send-sms/response-fields.adoc[]
Response Example
include::{snippets}/../../src/docs/asciidoc/send-sms/response-body.adoc[]
